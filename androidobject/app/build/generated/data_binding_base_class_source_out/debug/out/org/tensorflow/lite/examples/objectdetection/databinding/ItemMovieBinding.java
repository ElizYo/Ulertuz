...
public final class ItemMovieBinding implements ViewBinding {
  ...
  private ItemMovieBinding(@NonNull RelativeLayout rootView, @NonNull ImageView ivPortada,
  ...
  public static ItemMovieBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMovieBinding((RelativeLayout) rootView, ivPortada, tvTitulo);
    }

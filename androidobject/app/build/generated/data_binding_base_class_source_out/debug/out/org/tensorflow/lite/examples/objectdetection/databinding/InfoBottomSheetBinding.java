...
public final class InfoBottomSheetBinding implements ViewBinding {
  ...
  private InfoBottomSheetBinding(@NonNull NestedScrollView rootView,
      @NonNull NestedScrollView bottomSheetLayout, @NonNull Button btnLimpiar,
      @NonNull TextView textToDisplay, @NonNull TextView titulo) {
  ...
  public static InfoBottomSheetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.text_to_display;
      TextView textToDisplay = ViewBindings.findChildViewById(rootView, id);
      ...
      return new InfoBottomSheetBinding((NestedScrollView) rootView, bottomSheetLayout, btnLimpiar,
